...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div class="topics-item">Edit profile </div>
            ...
            <div id="follow-block">
            <a href="following.php"><b><?php echo $user[0]['following_number'];?></b> <span class="gray">Following</span></a>    
            ...
            <div class="follow-block">
                ...
                if ((bool)$isfollowed){
                    echo "<a href=\"profile.php?del_following=$item_id\">";
                    echo "<button id=\"unfollow-button\">Following</button></a>";
                }
                else {
                    echo "<a href=\"profile.php?del_follow=$item_id\">";
