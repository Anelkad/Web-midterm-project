...
<html>
    ...
    <body>
        <div id="menu">
            ...
            <div class="menu-item"><a href="notifications.php"><img src="https://raw.githubusercontent.com/monsterlessonsacademy/monsterlessonsacademy/e677aae424559c05e20f1a3f7d8f89a6680f448a/svg/notifications.svg" class="icons"><b>Notifications</b></a></div>
        ...
        <div id="main">
            <div class="fixed-title">
                ...
                <div class="title-part"><a href="notifications.php"><b>All</b><hr color="DeepSkyBlue" width="60" size="3"></a></div>
                <div class="title-part"><a href="mentions.php">Mentions</a><br></div>                
            </div>
            <div class="notifications">
                <span id="notifications-title">Nothing to see here — yet</span><br>
                <span id="notifications-text">From likes to Retweets and a whole lot more, this is where all the action happens.</span>
            </div>
    ...
    <div class="follow">
        ...
        <?php 
            ...
            $item_id = $item['user_id'];
                if ((bool)$isfollowed){
                    echo "<a href=\"notifications.php?del_following=$item_id\">";
                    echo "<button id=\"unfollow-button\">Following</button></a>";
                }
                else {
                    echo "<a href=\"notifications.php?del_follow=$item_id\">";
